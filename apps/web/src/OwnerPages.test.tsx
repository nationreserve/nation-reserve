...
describe("Prompt 015 Robot Owner portal",()=>{
  ...
  it("renders robot inventory filters and the honest API gap",()=>{render(<OwnerPage path="/owner/robots"/>);expect(screen.getByLabelText("Search by serial number")).toBeInTheDocument();expect(screen.getByText("Owner inventory API required")).toBeInTheDocument()});
